...
var target = hlp.networks.linkedin;
...
var db = hlp.getDB();
var model = db.model('linkedin', schema, 'linkedin');
            ...
            if (error || !results) {
                ...
                network.save(function(e){
                    if(e){
                        ...
                        cb(null, 'https://www.linkedin.com/uas/oauth/authenticate?oauth_token=' + oauth_token);
                    }
                })
            }
        });
